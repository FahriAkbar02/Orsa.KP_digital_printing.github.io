        ...
        <div class="col-md-6">
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="text-center">
                    <img width="210" class="img-responsive" src="<?= base_url() ?>/img/logo/T-Art Papua.png" style="margin-top: 20px;" alt="">
                </div>
                                ...
                                <form class="user" action="<?= route_to('login') ?>" method="post">
                                    ...
                                    <?php if ($config->validFields === ['email']) : ?>
                                        <div class="form-group">
                                         ...
                                         <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="<?= lang('Auth.email') ?>">
                                    ...
                                    <?php endif; ?>
                                    <button [disabled]="registerForm.invalid" type="submit" class="btn btn-primary btn-block"><?= lang('Auth.loginAction') ?>
                                    </button>
                                </form>
                                <hr>
